...
func registerAdminRoutes(mux *http.ServeMux, integrationHandler *erp.Handler, pages pageData) {
	...
	mux.HandleFunc("GET /office/conversations/{conversation_id}", adminDashboardHandler)
	...
	mux.HandleFunc("/office/system-settings", methodHandler("GET", adminDashboardHandler))
